const proyectoService = (() => {
    let proyectos = [
        { 
            ...
            estado: "En curso",
            descripcion: "Esta plataforma tiene como objetivo principal conectar a estudiantes que requieren apoyo académico con tutores especializados en diversas materias. El sistema gestionará la reserva de turnos, salas de videoconferencia y el seguimiento de los objetivos de aprendizaje.\n\nA través de una interfaz dinámica e intuitiva, los coordinadores podrán evaluar el rendimiento de las tutorías. Además, permitirá recopilar estadísticas en tiempo real para mejorar continuamente las estrategias de enseñanza de la institución educativa.",
            recursos: { 
        ...
        { 
            ...
            estado: "Finalizado",
            descripcion: "Un sistema web diseñado para digitalizar el catálogo de libros físicos de la institución y permitir el préstamo de material de lectura en formato digital. Resuelve la problemática del acceso limitado a la bibliografía obligatoria fuera del horario escolar.\n\nEl motor de búsqueda avanzado permite filtrar por autor, año, materia y palabras clave. Cuenta con un panel de administración robusto para la carga de nuevos ejemplares y la gestión de penalizaciones por devoluciones tardías.",
            recursos: { 
        ...
        { 
            ...
            estado: "En curso",
            descripcion: "Una plataforma educativa de e-learning pensada para la comunidad abierta que busca dictar cursos cortos de formación profesional. El sistema soporta la carga de contenidos en video, cuestionarios autoevaluativos y foros de discusión por cada módulo.\n\nEl diseño se enfoca en la accesibilidad web, permitiendo que personas con diferentes capacidades puedan navegar sin inconvenientes. Incluye un sistema automatizado para la generación y descarga de certificados en PDF al aprobar el trayecto.",
            recursos: { 
        ...
        { 
            ...
            categoria: "Programación", 
            estado: "Finalizado",
            descripcion: "Aplicación móvil y web orientada a que los estudiantes universitarios organicen sus horarios de cursada, fechas de exámenes parciales y entregas de trabajos prácticos. Envía notificaciones push automáticas un día antes de cada evento crítico.\n\nPermite sincronizar los calendarios personales con los cronogramas oficiales publicados por la facultad. Cuenta también con un módulo de cálculo estimado de promedio académico según las notas cargadas.",
            recursos: { 
        ...
        { 
            ...
            categoria: "Gestión", 
            estado: "En curso",
            descripcion: "La herramienta oficial que estamos desarrollando en esta cátedra. Permite realizar el seguimiento pormenorizado de las distintas iniciativas tecnológicas que nacen en la universidad, centralizando la lógica y las vistas en un entorno React.\n\nFacilita la transparencia de los recursos asignados y el estado actual de los entregables de cada grupo de alumnos. Su arquitectura modular garantiza que en próximas etapas se puedan integrar fácilmente sistemas de autenticación y roles de usuario.",
            recursos: { 
